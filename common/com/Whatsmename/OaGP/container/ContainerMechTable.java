...
public class ContainerMechTable extends Container
{
    ...
    public ContainerMechTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
