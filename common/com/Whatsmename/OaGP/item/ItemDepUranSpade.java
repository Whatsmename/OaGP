...
public class ItemDepUranSpade extends ItemSpade {

	public ItemDepUranSpade(int par1, EnumToolMaterial par2EnumToolMaterial) {
		super(par1, par2EnumToolMaterial);
		this.setCreativeTab(OaGP.TabOaGP);
		this.setUnlocalizedName(Strings.ITEMDEPURANSPADE_NAME);
	}
