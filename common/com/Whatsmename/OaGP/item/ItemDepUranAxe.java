...
public class ItemDepUranAxe extends ItemAxe {

	public ItemDepUranAxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
		super(par1, par2EnumToolMaterial);
		this.setCreativeTab(OaGP.TabOaGP);
		this.setUnlocalizedName(Strings.ITEMDEPURANAXE_NAME);
	}
