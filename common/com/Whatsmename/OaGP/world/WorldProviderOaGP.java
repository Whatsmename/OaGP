package com.Whatsmename.OaGP.world;
...
public class WorldProviderOaGP extends WorldProvider {

	private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(ModBiomes.minersParadise, this.dimensionId, this.dimensionId);
		this.dimensionId = ModDiment.DimID;
		this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderOaGP(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	public String getWelcomeMessage() {
		if ((this instanceof WorldProviderOaGP))
		{
			return "And on the 8th Day God said, 'Let there be ores.'";
		}
		return null;
	}
